<?php
    ...
    $result = '{"MyTeam":{"teamID":"'.$teamID.'" , "Kind":"'.$kind.'" , "teamName":"'.$teamName.'" , "avatarPath":"'.$avatarPath.'" , "backgroundPath":"'.$backgroundPath.'" , "Track":"'.$track.'" , "Title":"'.$title.'" , "Abstract":"'.$abstract.'" , "Address":'.$tempStr.' , "Members":'.$memberStr.'}}';
