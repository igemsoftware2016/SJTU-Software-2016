...
while ($row=$result->fetch_assoc()) 
{
	...
	else
	{
		...
		echo "<li name='$teamname' onclick=showTeamInfo('".$row['Team_Name']."') onmouseover=turnblue(this) onmouseout=turnwhite(this) value='$teamname'><img height=\"40px\" width=\"40px\"src=\"".$touxiang."\" />"."<a style=\"margin-bottom:50px;\">".$row['Team_Name']."</a></li>";
